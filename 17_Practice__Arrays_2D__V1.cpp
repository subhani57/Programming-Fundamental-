...
//const int COLS = 6; // Number of columns in each array
...
//	cout << maxSubmatrix;
//}
//void sunsubmatrix(int matrix[ROWS][COLS])
//{
//	int maxSubmatrix = 0;
//	for (int i = 0;i < ROWS;i++)
//	{
...
//						}
//					}
//					maxSubmatrix = max(maxSubmatrix, summatrix);
//				}
//			}
//		}
//	}
...
//}
//
////write a function which 2-d array of size mxn and return maximum sum sub matrix 
//// For Example : in case of matrix - 1, the program returns 15, and in matrix - 2, the program returns 17.
////int main()
////{
////	int matrix[][COLS] = {
////		{0,-2,-7,0,-1},
